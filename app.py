...
def index():
    ...
    skills = {
        'Desenvolvimento': [
            ...
            'description': 'Construção de aplicações web completas do zero (backend + frontend + banco de dados) com foco em escalabilidade, segurança e manutenção'},
            {'name': 'Desenvolvimento Mobile Híbrido', 'proficiency': 75,
            'description': 'Criação de apps Android e iOS via WebView (Appilix) com excelente performance e experiência de usuário'},
            {'name': 'APIs & Integrações', 'proficiency': 92,
            'description': 'Desenvolvimento de APIs REST, WebSockets em tempo real, webhooks e integração com serviços externos (pagamentos, IA, e-mail, etc.)'},
            {'name': 'Bancos de Dados', 'proficiency': 87,
            'description': 'Modelagem, otimização e gestão de MongoDB (NoSQL) e bancos relacionais'},
            {'name': 'Segurança de Aplicações', 'proficiency': 88,
            'description': 'Implementação de defense-in-depth, autenticação segura (OTP + JWT) e proteção contra ataques comuns'},
            {'name': 'DevOps & Deploy', 'proficiency': 78,
            'description': 'Configuração completa de servidores, DNS, domínios e deploy profissional (Railway, Render, cPanel)'},
        ],
        'Design': [
            {'name': 'UI/UX Design', 'proficiency': 95,
            'description': 'Criação de interfaces modernas, intuitivas e centradas na conversão (experiência real no ArtKoffee e landing pages)'},
            {'name': 'Identidade Visual & Branding', 'proficiency': 90,
            'description': 'Desenvolvimento completo de marcas: logotipo, paleta de cores, tipografia e guia de estilo'},
            {'name': 'Design Gráfico', 'proficiency': 90,
            'description': 'Criação de peças visuais para marketing digital, banners, posts e materiais promocionais'},
            {'name': 'Prototipagem', 'proficiency': 95,
            'description': 'Protótipos de alta fidelidade em PDF ou Figma com revisões inclusas antes do desenvolvimento'},
            {'name': 'Ilustração Digital', 'proficiency': 85,
            'description': 'Ilustrações originais para interfaces, apps e materiais de marca'},
        ],
        'Gerenciamento': [
            {'name': 'Gestão de Projetos', 'proficiency': 90,
            'description': 'Planejamento, execução e entrega de projetos completos dentro do prazo e orçamento'},
            {'name': 'Metodologias Ágeis', 'proficiency': 88,
            'description': 'Uso prático de Scrum e Kanban para entregas iterativas e flexíveis'},
            {'name': 'Comunicação com Cliente', 'proficiency': 95,
            'description': 'Levantamento claro de requisitos, alinhamento constante e gestão de expectativas'},
            {'name': 'Trabalho Autônomo', 'proficiency': 95,
            'description': 'Capacidade de entregar projetos completos de forma independente com alta qualidade e total ownership'},
        ],
        'Escritura': [
            {'name': 'Documentação Técnica', 'proficiency': 90,
            'description': 'Documentação clara de APIs, guias de usuário, READMEs e manuais de sistemas'},
            {'name': 'Criação de Conteúdo Técnico', 'proficiency': 85,
            'description': 'Artigos, posts e conteúdo educativo sobre desenvolvimento e tecnologia'},
            {'name': 'Redação para Marketing', 'proficiency': 80,
            'description': 'Textos persuasivos para landing pages, e-mails e materiais de venda'},
        ],
    }
    services = [
        {
