...
def index():
    ...
    skills = {
        'Desarrollo': [
            {'name': 'Desarrollo Full-Stack', 'proficiency': 95,
            'description': 'Construcción de aplicaciones web completas desde cero (backend + frontend + base de datos) con foco en escalabilidad y mantenimiento'},
            {'name': 'Desarrollo Mobile Híbrido', 'proficiency': 75,
            'description': 'Aplicaciones Android e iOS mediante WebView (Appilix) con excelente experiencia de usuario y performance'},
            {'name': 'APIs & Integraciones', 'proficiency': 92,
            'description': 'Creación de APIs REST, WebSockets en tiempo real, webhooks y integración con servicios externos (pagos, IA, email, etc.)'},
            {'name': 'Bancos de Datos', 'proficiency': 87,
            'description': 'Modelado y optimización de MongoDB (NoSQL) y bases de datos relacionales'},
            {'name': 'Segurança de Aplicações', 'proficiency': 88,
            'description': 'Implementación de defense-in-depth, autenticación segura (OTP + JWT), protección contra ataques comunes y buenas prácticas'},
            {'name': 'DevOps & Deploy', 'proficiency': 78,
            'description': 'Configuración completa de servidores (Railway, Render, cPanel), DNS, dominio y deploy profesional'},
        ],
        'Design': [
            {'name': 'UI/UX Design', 'proficiency': 95,
            'description': 'Diseño de interfaces modernas, intuitivas y centradas en conversión (experiencia probada en ArtKoffee y landing pages)'},
            {'name': 'Identidade Visual & Branding', 'proficiency': 90,
            'description': 'Creación de marcas completas: logotipo, paleta de colores, tipografía y guía de estilo'},
            {'name': 'Design Gráfico', 'proficiency': 90,
            'description': 'Creación de piezas visuales para marketing digital, banners, posts y materiales promocionales'},
            {'name': 'Prototipagem', 'proficiency': 95,
            'description': 'Protótipos de alta fidelidad (Figma / PDF) con revisiones incluidas antes de empezar el desarrollo'},
            {'name': 'Ilustração Digital', 'proficiency': 85,
            'description': 'Ilustraciones originales para interfaces y materiales de marca'},
        ],
        'Gerenciamento': [
            {'name': 'Gestão de Projetos', 'proficiency': 90,
            'description': 'Planificación, seguimiento y entrega de proyectos completos dentro del plazo y presupuesto'},
            {'name': 'Metodologías Ágeis', 'proficiency': 88,
            'description': 'Uso práctico de Scrum y Kanban para entregas iterativas y flexibles'},
            {'name': 'Comunicação com Cliente', 'proficiency': 95,
            'description': 'Levantamiento claro de requisitos, alineación constante y gestión de expectativas'},
            {'name': 'Trabajo Autónomo', 'proficiency': 95,
            'description': 'Capacidad de entregar proyectos completos de forma independiente con alta calidad y ownership total'},
        ],
        'Escritura': [
            {'name': 'Documentação Técnica', 'proficiency': 90,
            'description': 'Documentación clara de APIs, guías de usuario, READMEs y manuales de sistemas'},
            {'name': 'Criação de Conteúdo Técnico', 'proficiency': 85,
            'description': 'Artículos, posts y contenido educativo sobre desarrollo y tecnología'},
            {'name': 'Redação para Marketing', 'proficiency': 80,
            'description': 'Textos persuasivos para landing pages, emails y materiales de venta'},
        ],
    }
    services = [
        {
