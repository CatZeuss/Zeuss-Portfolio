...
def index():
    ...
    skills = {
        'Desenvolvimento': [
            ...
            'description': 'Desenvolvimento de aplicações completas — do banco de dados à interface — para web e mobile'},
            {'name': 'Desenvolvimento Mobile', 'proficiency': 80,
            'description': 'Aplicativos Android e iOS com foco em performance, UX e distribuição nas lojas'},
            {'name': 'APIs & Integrações', 'proficiency': 90,
            'description': 'Criação e integração de APIs REST, webhooks, gateways de pagamento e serviços de terceiros'},
            {'name': 'Bancos de Dados', 'proficiency': 85,
            'description': 'Modelagem e gestão de bancos relacionais (PostgreSQL, MySQL) e NoSQL (MongoDB, Firestore)'},
            {'name': 'Segurança de Aplicações', 'proficiency': 85,
            'description': 'Implementação de autenticação, autorização, criptografia e proteção contra ataques comuns (XSS, CSRF, SQLi)'},
            {'name': 'DevOps & Deploy', 'proficiency': 75,
            'description': 'Configuração de servidores, CI/CD, Docker e deploy em plataformas como Railway e VPS'},
        ],
        'Design': [
            {'name': 'UI/UX Design', 'proficiency': 95,
            'description': 'Design de interfaces centradas no usuário com foco em usabilidade, hierarquia visual e conversão'},
            {'name': 'Identidade Visual & Branding', 'proficiency': 90,
            'description': 'Criação de identidades visuais completas: logotipo, paleta, tipografia e guia de marca'},
            {'name': 'Design Gráfico', 'proficiency': 90,
            'description': 'Peças visuais para mídia digital e impressa — posts, banners, apresentações e materiais de marketing'},
            {'name': 'Prototipagem', 'proficiency': 95,
            'description': 'Protótipos interativos de alta fidelidade em Figma para validação antes do desenvolvimento'},
            {'name': 'Ilustração Digital', 'proficiency': 85,
            'description': 'Ilustrações originais para produtos, apps e identidades visuais'},
        ],
        'Gerenciamento': [
            {'name': 'Gestão de Projetos', 'proficiency': 90,
            'description': 'Planejamento, execução e entrega de projetos digitais complexos dentro do prazo e escopo'},
            {'name': 'Metodologias Ágeis', 'proficiency': 90,
            'description': 'Aplicação de Scrum e Kanban para entregas iterativas e adaptação rápida a mudanças'},
            {'name': 'Comunicação com Cliente', 'proficiency': 95,
            'description': 'Levantamento de requisitos, gestão de expectativas, feedbacks e alinhamento contínuo ao longo do projeto'},
            {'name': 'Liderança Técnica', 'proficiency': 75,
            'description': 'Coordenação de equipes de desenvolvimento, revisão de código e definição de arquitetura'},
        ],
        'Escritura': [
            {'name': 'Documentação Técnica', 'proficiency': 90,
            'description': 'Escrita de docs de API, guias de uso, READMEs e manuais para sistemas e produtos digitais'},
            {'name': 'Criação de Conteúdo', 'proficiency': 82,
            'description': 'Artigos técnicos, posts de blog e conteúdo educativo sobre tecnologia e desenvolvimento'},
            {'name': 'Redação para Marketing Digital', 'proficiency': 78,
            'description': 'Copy para landing pages, e-mails, redes sociais e materiais de vendas com foco em conversão'},
            {'name': 'Redação Jurídica Básica', 'proficiency': 75,
            'description': 'Elaboração de termos de uso, políticas de privacidade e contratos de prestação de serviço'},
        ],
    }
    services = [
        {
